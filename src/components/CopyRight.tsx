export default function CopyRight() {
  return (
    <div className="w-full flex flex-col justify-center theme__bg-floral-white">
      <div className="container mx-auto flex flex-col justify-center items-center">
        <div className="flex w-full max-w-full  flex-col justify-center gap-6 py-4 px-4">
          <p className="text-center text-gray-950">
            ...
            <span className="pt-3">📱 351 93 620 5962 | 🌍 Crafted with purpose and creativity by Welinton Fernandes</span>
          </p>
        </div>
      </div>
    </div>
